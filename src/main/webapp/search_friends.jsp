...
<body>
	...
	<!-- Content Start-->
	<c:forEach varStatus="stVar" var="aFriendBean" items="${friends_DSF}">
		<div class="container">
			<div class="row">
				<div class="col-md-6 col-md-offset-3" id="mySearchF">
					...
					<div class="row">
						...
						<form action="RequestFriend.do" method="POST"
							name="RequestFriendForm">
							<input type="hidden" id="oID" name="oID"
								value="${aFriendBean.userID}" /> <input type="submit"
								value="發送好友邀請" class="btn btn-large btn-default" />
						</form>
					</div>
				</div>
			</div>

...
<title>Welcome to Jabong! - Register</title>
</head>
<body>
	<!-- 載入器START -->
	<div class="loader">
	...
	<!-- 幻燈片START -->
	<div id="supersize">
		<a> <img src="images/login3.png" />
		</a> <a> <img src="images/login1.jpg" />
		</a> <a> <img src="images/login2.jpg" />
		</a>
	</div>
	<!-- 幻燈片END -->
	<!-- 註冊介面START -->
					...
					<div class="login">
						<form ENCTYPE="multipart/form-data" method="POST"
							...
							<input type="text" placeholder="username" name="name"
								required="true"> <input type="password"
								placeholder="password" name="pw" required="true"> <input
								type="email" placeholder="email" name="email" required="true">
							<input type="tel" placeholder="phone number" name="mobile"
								required="true"> <input type="submit" value="Sign up">
						</form>
					</div>
				</div>
			</div>

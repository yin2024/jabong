...
//	}
	...
	try {
		...
		NotifyAccessBean nab = new NotifyAccessBean();
		nab.setUserID(mb.getUserID());
		coll = nab.getAllNotify();
		System.out.println(coll);
		session.setAttribute("Notify", coll);
...
//		response.sendRedirect(response.encodeRedirectURL(request.getContextPath()));
		response.sendRedirect(response.encodeRedirectURL(request.getContextPath()+ "/DisplayPosts" ));
		return;
	    }
	} else {

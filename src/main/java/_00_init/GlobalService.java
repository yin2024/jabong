...
public class GlobalService {
    ...
    public static final String host = "127.2.59.2";
    public static final String USERID = "adminlfpZiA8";
    public static final String PASSWORD = "zQjFHBlpieSq";
    public static final String SYSTEM_NAME = "Jabong";
    public static final String DB_NAME = "jabong";
//    public static final String JNDI_DB_NAME = "java:comp/env/jdbc/" + GlobalService.DB_NAME;
    public static final String JNDI_DB_NAME = "java:comp/env/jdbc/MySQLDS";
    public static final int IMAGE_FILENAME_LENGTH = 20;
    public static final String DB_URL = "jdbc:mysql://" + GlobalService.host + ":3306/" + GlobalService.DB_NAME;
    ...
    // //
    // File file = new
    // File("C:\\Users\\Student\\Desktop\\apache-tomcat-8.0.30-windows-x64.zip");

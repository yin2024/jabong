...
@WebServlet("/InsertPostResp.do")
public class InsertPostResp extends HttpServlet {
	...
	PostRespBean prb = new PostRespBean();
	prb.setPostID(postID);
	prb.setUserID(userID);
	prb.setResponse(resp);
	PostAccessBean pab;
